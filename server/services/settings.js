...
const ALLOWED = new Set([
  ...
  'ELEVENLABS_API_KEY', 'ELEVENLABS_VOICE_ID', 'VOICE_REPLIES', 'QUICK_ORDER', 'ADMIN_PHONE', 'SUPERVISOR_NAME', 'SUPERVISOR_ID', 'PAYMENT_MODE', 'MOYASAR_SECRET_KEY', 'COMMISSION_BUSINESS_PERCENT', 'COMMISSION_CAPTAIN_PERCENT', 'BUSINESS_SUBSCRIPTION', 'CAPTAIN_DEPOSIT', 'PLATFORM_REPORT_HOUR', 'LATE_PENALTY', 'BID_WINDOW_SECONDS', 'REPORT_TZ_OFFSET_MIN'
]);
