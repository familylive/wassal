...
const ALLOWED = new Set([
  ...
  'ELEVENLABS_API_KEY', 'ELEVENLABS_VOICE_ID', 'VOICE_REPLIES', 'QUICK_ORDER', 'ADMIN_PHONE', 'SUPERVISOR_NAME', 'SUPERVISOR_ID', 'COMMISSION_BUSINESS_PERCENT', 'COMMISSION_CAPTAIN_PERCENT', 'BUSINESS_SUBSCRIPTION', 'CAPTAIN_DEPOSIT'
]);
